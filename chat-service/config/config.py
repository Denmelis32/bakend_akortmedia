...
class Config:
    ...
    def __init__(self):
        ...
        self.RATE_LIMIT_AVATAR_UPLOAD = 10  # per minute
        ...
        self.AVATAR_CACHE_TTL_SECONDS = 3600  # 1 hour
        ...
        # ==========================================================================
        # WebSocket Configuration (для уведомлений)
        # ==========================================================================
        self.WEBSOCKET_URL = os.getenv('WEBSOCKET_URL', 'http://127.0.0.1:8000')
        self.WEBSOCKET_API_KEY = os.getenv('WEBSOCKET_API_KEY', 'ws-server-secret-key-2026')
        self.WEBSOCKET_TIMEOUT = int(os.getenv('WEBSOCKET_TIMEOUT', '10'))
